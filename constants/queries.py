...
INSERT_PARTICIPANTS_NO_PHOTO = "INSERT INTO participants(id, username, fullname, job, interests, active) " \
                      "VALUES({0}, '{1}', '{2}', '{3}', '{4}', {5})"
...
UPDATE_PARTICIPANTS_NO_PHOTO = "UPDATE participants SET username = '{1}', fullname = '{2}', job = '{3}', " \
                               "interests = '{4}', active = {5} WHERE id = {0}"
